...
function Sort({ filter, onFilterChange, sort, onSortChange, taskCount, toggleActive, onToggleActive }: SortProps) {
  return (
    <div className="todoTask__header">
      <button
        onClick={onToggleActive}
        className={`todoTask__toggle js_todoTask_toggle ${!toggleActive ? "is-closed" : ""}`}
      ></button>
      ...
      <div className="todoTask__selectWrapper">
        ...
        <select
          className="todoTask__select js_todoTask_filter"
          value={filter}
        ...
        <select
          className="todoTask__select js_todoTask_sort"
          value={sort}
